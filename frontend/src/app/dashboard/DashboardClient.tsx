                ...
                <AnimatePresence mode="wait">
                    {!isProcessing && !results && (
                        <m.div
                            ...
                            className={`w-full flex flex-col items-center animate-fade-in-up ${isPending ? 'opacity-70 pointer-events-none' : ''}`}
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row bg-slate-900/80 p-1.5 rounded-2xl sm:rounded-full mb-12 sm:mb-16 border border-white/10 shadow-xl shadow-blue-500/5 gap-2 sm:gap-0">
                                ...
                                <button
                                    onClick={() => startTransition(() => setMode('generate'))}
                                            ...
                                            <div className="mt-12 text-center w-full">
                                                ...
                                                <div className="flex flex-wrap justify-center gap-5">
                                                    {[
                                                        ...
                                                        <button
                                                            key={sample.id}
                                                            onClick={() => startTransition(() => loadSampleDataset(sample.id))}
                                                            className={`group px-6 py-3.5 rounded-[1.5rem] bg-white/[0.03] hover:bg-white/[0.08] transition-all border border-white/10 text-xs font-bold flex items-center gap-4 hover:border-white/30 hover:shadow-2xl ${sample.glow} ${isPending ? 'opacity-50 cursor-not-allowed' : ''}`}
                                                        >
